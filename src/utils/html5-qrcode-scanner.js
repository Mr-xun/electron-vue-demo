...
export class Html5QrcodeScanner {
    ...
    static ASSET_CAMERA_SCAN = require("../assets/qrcode-scanner/ic_camera_scan.gif");
    static ASSET_SWITCH_CAMERA = require('../assets/qrcode-scanner/ic_switch_camera.png');
    static ASSET_STOP_SCAN = require('../assets/qrcode-scanner/ic_stop.png');
    ...
    __createSectionControlPanel() {
        ...
        cameraActionStartButton.innerHTML = "摄像头扫码";
