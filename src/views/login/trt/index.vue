  ...
  <div class="login-container">
    <div class="login-info">
      ...
      <!-- <div class="theme-wrap">
        <img class="theme-title"  src="../../../assets/zyt/login-title.png" alt="" srcset="">
        <img class="theme-img" src="../../../assets/zyt/login-bg.jpg" alt="" srcset="">
      </div> -->
    </div>
    <el-form ref="loginForm" :model="loginForm" :rules="rules" class="login-form" autocomplete="off" label-position="left">
      <div class="title-container">
        <h3 class="title">
          <img class="logo-img" src="../../../assets/trt/main-logo.png" alt="" srcset="">
    ...
    <span class="login-footer">
      © 2020 <a target="_blank" href="#">北京中科天维科技有限公司</a> - DCMS
    </span>
  </div>
</template>
    ...
    data() {
        return {
            ...
            rules: {
                ...
                bindUsername: { required: true, message: '不能为空', trigger: 'blur' },
                bindPassword: { required: true, message: '不能为空', trigger: 'blur' },
                signUsername: [
    ...
    methods: {
        ...
        resolveSocialLogin(e) {
            ...
            if (data.message === 'not_bind') {
                ...
                that.$confirm('当前' + authUser.source + '账号' + authUser.nickname + '尚未绑定任何系统账户，您可以绑定系统账户或者注册一个新的账户并绑定。', '提示', {
        ...
        bindLogin() {
            let usernameC = false;
            let passwordC = false;
            this.$refs.loginForm.validateField('bindUsername', e => { if (!e) { usernameC = true; } });
            this.$refs.loginForm.validateField('bindPassword', e => { if (!e) { passwordC = true; } });
        ...
        signLogin() {
            let usernameC = false;
            let passwordC = false;
            this.$refs.loginForm.validateField('signUsername', e => { if (!e) { usernameC = true; } });
            this.$refs.loginForm.validateField('signPassword', e => { if (!e) { passwordC = true; } });
            if (usernameC && passwordC) {
                this.loading = true;
                const that = this;
                const params = {
        ...
        handleLogin() {
            ...
            let passwordC = false;
            let codeC = false;
            this.$refs.loginForm.validateField('username', e => { if (!e) { usernameC = true; } });
            this.$refs.loginForm.validateField('password', e => { if (!e) { passwordC = true; } });
            this.$refs.loginForm.validateField('code', e => { if (!e) { codeC = true; } });
