  ...
  <div class="login-container">
    <div class="login-info">
      ...
      <div class="theme-wrap">
        <img class="theme-title"  src="../../../assets/gc/login-title.png" alt="" srcset="">
        <img class="theme-img" src="../../../assets/gc/login-bg.jpg" alt="" srcset="">
      </div>
    </div>
    <el-form ref="loginForm" :model="loginForm" :rules="rules" class="login-form" autocomplete="off" label-position="left">
      <div class="title-container">
        <h3 class="title">
          <img class="logo-img" src="../../../assets/gc/main-logo.png" alt="" srcset="">
