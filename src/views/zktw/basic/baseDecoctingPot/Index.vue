				...
				<el-form-item label style="margin-left:0.75rem;">
					...
					<el-dropdown trigger="click" class="filter-item">
						...
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item @click.native="add" v-has-permission="['baseDecoctingPot:add']">新增</el-dropdown-item>
							<el-dropdown-item
								@click.native="batchDelete"
								v-has-permission="['baseDecoctingPot:delete']"
							>删除</el-dropdown-item>
							<el-dropdown-item
								@click.native="exportExcel"
								v-has-permission="['baseDecoctingPot:export']"
							>导出</el-dropdown-item>
						</el-dropdown-menu>
					</el-dropdown>
				</el-form-item>
		...
		<div class="center-container">
			...
			>
				...
				<el-table-column
					...
					prop="isValid"
				>
					<template slot-scope="{row}">{{row.isValid |flYesOrNo}}</template>
				</el-table-column>
				<el-table-column
					label="流水号"
					:show-overflow-tooltip="true"
				...
				>
					<template slot-scope="{row}">
						<i
							...
							style="color: #2db7f5;"
							v-has-permission="['baseDecoctingPot:update']"
							@click="edit(row)"
						/>
						<i
						...
						/>
						<el-link
							v-has-no-permission="['baseDecoctingPot:update','baseDecoctingPot:delete']"
							class="no-perm"
						>无权限</el-link>
					</template>
				</el-table-column>
...
export default {
    ...
    methods: {
        ...
        exportExcel() {
            ...
            this.$api.basic_baseDecoctingPot_export(
                params,
                `煎药锅档案_${new Date().getTime()}.xlsx`
            );
        },
        fileUpload() {},
        singleDelete(row) {
        ...
        delete(deleteIds) {
            this.$api.basic_baseDecoctingPot_delete(deleteIds).then(() => {
                this.$message({
                    message: '删除成功',
                    type: 'success'
                });
