            ...
            <el-form :inline="true" :model="queryParams">
                ...
                <el-form-item label style="margin-left:0.75rem;">
                    ...
                    <el-dropdown
                        trigger="click"
                        class="filter-item"
                        v-has-any-permission="['basePhysician:add','basePhysician:delete','basePhysician:export']"
                    >
                        <el-button>
                            更多操作
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item
                                @click.native="add"
                                v-has-permission="['basePhysician:add']"
                            >新增</el-dropdown-item>
                            <el-dropdown-item
                                @click.native="batchDelete"
                                v-has-permission="['basePhysician:delete']"
                            >删除</el-dropdown-item>
                            <el-dropdown-item
                                @click.native="exportExcel"
                                v-has-permission="['basePhysician:export']"
                            >导出</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-form-item>
                ...
                >
                    <template slot-scope="{row}">
                        <i
                            ...
                            style="color: #2db7f5;"
                            v-has-permission="['basePhysician:update']"
                            @click="edit(row)"
                        />
                        <i
                        ...
                        />
                        <el-link
                            v-has-no-permission="['basePhysician:update','basePhysician:delete']"
                            class="no-perm"
                        >无权限</el-link>
                    </template>
                </el-table-column>
...
import PhysicianEdit from './Edit';
import { mapGetters } from 'vuex';

export default {
    name: 'BasePhysicianEdit',
    components: { Pagination, PhysicianEdit },
    data() {
        return {
            dialog: {
                isVisible: false,
    ...
    methods: {
        ...
        exportExcel() {
            ...
            this.$api.basic_basePhysician_export(
                params,
                `医师档案_${new Date().getTime()}.xlsx`
            );
        },
        fileUpload() {},
        singleDelete(row) {
