<template>
  ...
  >
    <div class="add-filter-container">
      <el-form ref="form" :inline="true" :model="searchForm" label-width="80px" class>
        <el-form-item label="搜索条件">
          <el-select size="mini" v-model="searchForm.select" @change="chooseContent" clearable>
            <el-option label="商品编码" value="code"></el-option>
            <el-option label="商品名称" value="name"></el-option>
            <el-option label="速记码" value="shorthandCode"></el-option>
          </el-select>
          <el-input
    ...
    >
      ...
      <el-table-column label="单位" :show-overflow-tooltip="true" align="center" prop="unit"></el-table-column>
      ...
      >
        <template slot-scope="{row}">
          <el-input-number size="mini" :min="0" v-model="row.qty"></el-input-number>
