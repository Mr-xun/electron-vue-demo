            ...
            >
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.prescription | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="付数"
                ...
                <el-table-column
                    ...
                    :show-overflow-tooltip="true"
                    align="center"
                    prop="totalMedicineAmoun"
                >
                    <template slot-scope="{ row }">
                        {{ row.totalMedicineAmoun | formatMoney }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="煎药费"
...
export default {
    ...
    methods: {
        getSummaries(param) {
            ...
            let noFormatVal = [2, 3, 4, 5, 9, 10]; //不需要处理列
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_prescriptionReport_creatorStatisticsExcel(
                params,
                `计价员统计_${new Date().getTime()}.xlsx`
            );
