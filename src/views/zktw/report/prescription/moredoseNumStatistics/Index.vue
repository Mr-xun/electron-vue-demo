    ...
    <div class="app-container report-container">
        <div class="filter-container">
            <el-form :inline="true" :model="queryParams">
                ...
                <el-form-item label="大于付数">
                    <el-input
                        v-model="queryParams.doseNum"
                        clearable
                        @clear="search"
...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_prescriptionReport_moredoseNumStatisticsExcel(
                params,
                `代煎超出付数查询_${new Date().getTime()}.xlsx`
            );
