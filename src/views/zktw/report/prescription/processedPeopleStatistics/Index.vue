        ...
        <div class="filter-container">
            <el-form :inline="true" :model="queryParams">
                <el-form-item label="加工人员">
                    <el-select
                        v-model="queryParams.processedPeople"
                        clearable
                        filterable
                        autocomplete="on"
...
export default {
    name: 'ProcessedPeopleStatistics',
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_prescriptionReport_processedPeopleStatisticsExcel(
                params,
                `加工人员统计_${new Date().getTime()}.xlsx`
            );
