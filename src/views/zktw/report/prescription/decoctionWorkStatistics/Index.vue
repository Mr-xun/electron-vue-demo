    ...
    <div class="app-container report-container">
        <div class="filter-container">
            <el-form :inline="true" :model="queryParams">
                <el-form-item label="煎药员">
                    <el-select
                        v-model="queryParams.decoctingPotPerson"
                        clearable
                        filterable
                        autocomplete="on"
            ...
            >
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.prescriptionNum | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="付数"
...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_prescriptionReport_decoctionWorkStatisticsExcel(
                params,
                `煎药工作量统计_${new Date().getTime()}.xlsx`
            );
