    ...
    <div class="app-container report-container">
        <div class="filter-container">
            <el-form :inline="true" :model="queryParams">
                <el-form-item label="调剂员">
                    <el-select
                        v-model="queryParams.dispenser"
                        clearable
                        filterable
                        autocomplete="on"
...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_prescriptionReport_dispenserStatisticsExcel(
                params,
                `调剂员统计_${new Date().getTime()}.xlsx`
            );
