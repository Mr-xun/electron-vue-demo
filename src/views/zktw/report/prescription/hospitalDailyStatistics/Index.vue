        ...
        <div class="filter-container">
            <el-form :inline="true" :model="queryParams">
                ...
                <el-form-item label="送货上门">
                    <el-select
                        v-model="queryParams.deliveryToDoor"
                        clearable
                        filterable
                        autocomplete="on"
                        default-first-option
...
export default {
    ...
    methods: {
        getSummaries(param) {
            ...
            let noFormatVal = [2, 3, 4, 5, 6, 7, 8]; //不需要处理列
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes = await this.$api.report_prescriptionReport_hospitalDailyStatisticsExcel(
                params,
                `医院日报_${new Date().getTime()}.xlsx`
            );
