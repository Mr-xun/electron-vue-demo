...
export default {
    ...
    methods: {
        getSummaries(param) {
            ...
            let noFormatVal = [13, 14, 15, 16, 17, 18, 19, 20, 21]; //不需要处理列
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_prescriptionReport_hospitalKindStatisticsExcel(
                params,
                `医院品种月统计_${new Date().getTime()}.xlsx`
            );
