    ...
    <div class="app-container report-container">
        <div class="filter-container">
            <el-form :inline="true" :model="queryParams">
                <el-form-item label="包装称重员">
                    <el-select
                        v-model="queryParams.weigher"
                        clearable
                        filterable
                        autocomplete="on"
...
export default {
    ...
    methods: {
        getSummaries(param) {
            ...
            let noFormatVal = [3, 4, 5, 6, 7, 8, 9, 10]; //不需要处理列
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_prescriptionReport_packerWeigherStatisticsExcel(
                params,
                `包装称重员统计_${new Date().getTime()}.xlsx`
            );
