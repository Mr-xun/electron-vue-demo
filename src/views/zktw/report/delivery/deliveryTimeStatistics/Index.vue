...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_deliveryReport_deliveryTimeStatisticsExcel(
                params,
                `送货时间查询_${new Date().getTime()}.xlsx`
            );
