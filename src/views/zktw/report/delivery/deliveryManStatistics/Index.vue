...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_deliveryReport_deliveryManStatisticsExcel(
                params,
                `送货员统计_${new Date().getTime()}.xlsx`
            );
