    ...
    <div class="app-container report-container">
        ...
        <div class="center-container">
            ...
            >
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.totalPrescNum | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="付数"
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.totalDoseNum | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="趟数"
...
export default {
    name: 'DeliveryManTotalNumStatistics',
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_deliveryReport_deliveryManTotalNumStatisticsExcel(
                params,
                `送货员统计总数_${new Date().getTime()}.xlsx`
            );
