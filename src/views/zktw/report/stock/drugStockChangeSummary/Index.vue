        ...
        <div class="center-container">
            ...
            >
                ...
                <el-table-column
                    ...
                    :show-overflow-tooltip="true"
                    align="center"
                    prop="purchaseReturnQty"
                    min-width="90px"
                >
                    <template slot-scope="{ row }">
                        {{ row.purchaseReturnQty | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="销售数量"
                ...
                <el-table-column
                    ...
                    align="center"
                    min-width="90px"
                    prop="inventoryProfitQty"
                >
                    <template slot-scope="{ row }">
                        {{ row.inventoryProfitQty | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="盘亏数量"
                    ...
                    align="center"
                    min-width="90px"
                    prop="inventoryLossQty"
                >
                    <template slot-scope="{ row }">
                        {{ row.inventoryLossQty | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="移出数量"
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.transferOutQty | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="移入数量"
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.transferInQty | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="购进成本"
                ...
                <el-table-column
                    ...
                    align="center"
                    min-width="100px"
                    prop="purchaseReturnCost"
                >
                    <template slot-scope="{ row }">
                        {{ row.purchaseReturnCost | formatMoney }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="销售成本"
                ...
                <el-table-column
                    ...
                    align="center"
                    min-width="100px"
                    prop="inventoryProfitCost"
                >
                    <template slot-scope="{ row }">
                        {{ row.inventoryProfitCost | formatMoney }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="盘亏成本"
                    ...
                    align="center"
                    min-width="100px"
                    prop="inventoryLossCost"
                >
                    <template slot-scope="{ row }">
                        {{ row.inventoryLossCost | formatMoney }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="移出成本"
                    ...
                    align="center"
                    min-width="100px"
                    prop="transferOutCost"
                >
                    <template slot-scope="{ row }">
                        {{ row.transferOutCost | formatMoney }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="移入成本"
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.transferInCost | formatMoney }}
                    </template>
                </el-table-column>
            </el-table>
            <pagination
...
export default {
    ...
    methods: {
        getSummaries(param) {
            ...
            let noFormatVal = [9, 10, 11, 12, 13, 14, 15];
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_stockReport_drugStockChangeSummaryExcel(
                params,
                `商品入出库汇总_${new Date().getTime()}.xlsx`
            );
