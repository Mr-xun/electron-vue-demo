        ...
        <div class="filter-container">
            <el-form :inline="true" :model="queryParams">
                ...
                <el-form-item label="处方号">
                    <el-input
                        v-model="queryParams.prescriptionOrder"
                        clearable
                        @clear="search"
                        @keyup.enter.native="search"
                        placeholder="处方号"
...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_stockReport_salePendingOutExcel(
                params,
                `销售待出库_${new Date().getTime()}.xlsx`
            );
