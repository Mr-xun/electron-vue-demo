<template>
    <div class="app-container purchase-pending-container">
...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_purchaseReport_pendingExport(
                params,
                `采购待入库_${new Date().getTime()}.xlsx`
            );
