<template>
	<div class="app-container purchase-returnrecord-container">
...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes = await this.$api.report_purchaseReport_returnRecordExport(
                params,
                `采购退货记录_${new Date().getTime()}.xlsx`
            );
...
.purchase-returnrecord-container {
