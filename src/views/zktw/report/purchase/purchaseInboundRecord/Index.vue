    ...
    <div class="app-container purchase-inboundrecord-container">
        ...
        <div class="center-container">
            ...
            >
                ...
                >
                    <template slot-scope="{ row }">
                        {{ row.qualifiedQty | formatMoney(0) }}
                    </template>
                </el-table-column>
                <el-table-column
                    label="拒收数量"
...
export default {
    ...
    methods: {
        ...
        async exportExcel(type = 'current') {
            ...
            let exportRes= await this.$api.report_purchaseReport_inboundRecordExcel(
                params,
                `采购入库记录_${new Date().getTime()}.xlsx`
            );
