				...
				>
					<template slot-scope="{ row }">
						<el-button
							...
							type="success"
							icon="el-icon-check"
							@click="destructionConfirm(row)"
							v-has-permission="['destructionConfirm:confirm']"
							>确认销毁</el-button
						>
						<el-link
							v-has-no-permission="['destructionConfirm:confirm']"
							class="no-perm"
							>无权限</el-link
						>
					</template>
