...
export default {
    ...
    methods: {
        ...
        submit(row) {
            this.$api
                .prescription_prescriptionOrder_completeAdjust(this.adjustForm)
                .then((res) => {
                    this.operateOrderStatus = true;
                    this.operateOrderInfo = `处方${row.orderNo}完成调剂成功`;
                    this.$message({
                        message: `处方${row.orderNo}完成调剂成功`,
                        type: 'success'
                    });
                ...
                .catch((err) => {
                    console.log(err);
                    this.operateOrderInfo = `处方${row.orderNo}完成调剂失败`;
